...
// parties.
//func NewKeySwitchProtocol(params rlwe.ParameterProvider, noiseFlooding ring.DistributionParameters) (KeySwitchProtocol, error) { // MODIFICATION TO CHECK THE TRUE NOISE
func NewKeySwitchProtocol(params rlwe.ParameterProvider, noiseFlooding ring.DistributionParameters, without_eFresh ...bool) (KeySwitchProtocol, error) {
