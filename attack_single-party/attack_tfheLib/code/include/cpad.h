...
void test_cpad(uint64_t plain_mod, int64_t pt_msg, int n_samples, bool print_info, bool verbose=true);
void test_cpad_simple(uint64_t plain_mod, int64_t pt_msg, bool print_info, bool verbose=true);
